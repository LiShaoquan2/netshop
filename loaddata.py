...
from goodsapp.models import Category, Goods, Size, Color, GoodsDetailName, Inventory, GoodsDetail
...
def test_model():
    with open('jiukuaijiu.json') as fr:
        ...
        for data in datas:
            ...
            for goods in _goods:
                good = Goods.objects.create(gname=goods['goodsname'],gdesc = goods['goods_desc'],price=goods['goods_price'],oldprice=goods['goods_oldprice'],category=cate)
